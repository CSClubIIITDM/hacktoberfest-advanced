...
For each string, we start looking for palindromic string from the right.
For each index we check if elements to the right of the string and elements to the right of the 
